...
namespace PetIdServer.Application.Domain.Owner.Commands.Registration;
    ...
    : IRequestHandler<RegistrationOwnerCommand, TokenPairDto>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        OwnerEntity.CreationAttributes creationAttributes = new(request.Email, passwordHash, request.Name);
        OwnerEntity owner = new(creationAttributes);
