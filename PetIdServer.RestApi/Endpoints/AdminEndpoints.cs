...
using PetIdServer.Application.Tag.Commands.Clear;
using PetIdServer.Application.Tag.Commands.CreateBatch;
using PetIdServer.Application.Tag.Dto;
using PetIdServer.Application.Tag.Queries.GetAll;
using PetIdServer.Application.Tag.Queries.GetDecoded;
using PetIdServer.Application.TagReport.Commands.Create;
using PetIdServer.Application.TagReport.Commands.Resolve;
using PetIdServer.Application.TagReport.Dto;
using PetIdServer.Application.TagReport.Queries.GetAll;
